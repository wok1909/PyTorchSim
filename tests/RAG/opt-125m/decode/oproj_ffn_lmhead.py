...
def main():
    parser = add_common_bench_args(argparse.ArgumentParser(description="OPT-125M DECODE OPROJ_FFN_LMHEAD latency"))
    ...
    print_result("decode", "oproj_ffn_lmhead", args, stats)
